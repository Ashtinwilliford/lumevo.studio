...
export default function ScriptPage() {
  ...
  if (!project) return <div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",background:"#09090b"}}><div style={{width:8,height:8,background:"#e8ff47",borderRadius:"50%"}} /></div>;
  ...
  return (
    <>
      <style>{`
        ...
        :root { --bg:#09090b; --surface:#111113; --surface2:#18181b; --border:rgba(255,255,255,0.07); --accent:#e8ff47; --accent2:#ff6b6b; --text:#f4f4f5; --muted:#71717a; --radius:14px; }
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .input-field:focus { border-color:rgba(232,255,71,0.4); }
        ...
        .chip-idle { background:transparent; border-color:var(--border); color:var(--muted); }
        .chip-idle:hover { border-color:rgba(255,255,255,0.2); color:var(--text); }
        .chip-active { background:var(--accent); border-color:var(--accent); color:#09090b; }
        .action-row { display:flex; align-items:center; gap:12px; margin-top:44px; flex-wrap:wrap; }
        .btn-primary { display:flex; align-items:center; gap:8px; background:var(--accent); color:#09090b; font-family:inherit; font-size:14px; font-weight:600; border:none; border-radius:999px; padding:12px 24px; cursor:pointer; transition:opacity 0.2s,transform 0.15s; }
        ...
        .saved-badge { font-size:13px; color:var(--accent); font-weight:500; }
        .error-msg { font-size:13px; color:var(--accent2); margin-top:12px; }
        ...
        .spinner { width:18px; height:18px; border:2px solid rgba(9,9,11,0.3); border-top-color:#09090b; border-radius:50%; animation:spin 0.6s linear infinite; }
