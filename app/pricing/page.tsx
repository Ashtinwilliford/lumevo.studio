...
const PLANS = [
  ...
  },
  {
    ...
    price: "$199",
    per: "/ month",
    desc: "You stop making content. Lumevo does it for you — in your voice, your style, every single day. This is the full creative engine.",
    cta: "Let Lumevo Run It",
    highlight: true,
    features: [
      "Everything in Pro",
      "Daily AI-generated content, hands-free",
      "Script → Voice → Video, fully automated",
      "Your cloned voice on every post",
      "AI creative director conversation",
      "Content repurposing across all platforms",
      "AI social media manager workflow",
      "Deepest brand memory & style training",
      "Performance learning — improves every week",
